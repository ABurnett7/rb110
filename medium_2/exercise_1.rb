...
# P.  Input text, see which sentence contains the most words.

# E: provided and self-explanatory.

# D: Input: 1 - many sentences as a single string
# Need a way to seperate sentences from each other.
# Need a way to keep track of the word count of each sentence
# Output: String, that is the sentence with the most words. 

# A: CREATE a list of sentences
# SPLIT sentence into list of words to SORT by size.  
# PRINT the first sentence


def longest_sentence(text)
  sentences = text.split(/\.|\?|!/)
  sentences = sentences.sort { |sentence| sentence.split.size }.reverse
  p sentences[0]
end
...
example_text_2 = "The Project Gutenberg eBook of Frankenstein; Or, The Modern Prometheus
...
p longest_sentence(example_text_2)
